    ...
    <div class="flex justify-center items-center h-screen">
        <div class="flex items-center text-stone-500 justify-between fixed top-0 right-0 left-0 mt-4 mx-8">
            <div class="flex items-center gap-x-4">
                ...
                <h1 class="text-2xl font-semibold text-stone-500">Login</h1>
            </div>
            <img class="w-12" src="/img/Logo.png" alt="">
        </div>
        <div class="w-full max-w-sm leading-normal">
            <div class="mx-8">
                <form class="space-y-4" action="/login/auth" method="POST">
                ...
                <div class="text-gray-400 space-y-2">
                    ...
                    <p>Belum punya akun?<a href="/daftar" class="text-blue-500">Daftar</a></p>
                </div>
            </div>
        </div>
    </div>
